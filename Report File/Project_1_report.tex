...
\begin{verbatim}
##                             Description     R2
## 1 Absolute difference in deaths imputed 0.0024
## 2                                             
## 3                                             
## 4                                             
## 5                                             
## 6                                             
##                           Variables Estimate Std err p-val
## 1                       (Intercept)  -347.91 1996.75  0.86
## 2         `AmericasNot in Americas`  1991.23 2068.09  0.34
## 3                      StartYR_Norm     1.33   14.45  0.93
## 4                        WDuratDays    -0.69    0.63  0.27
## 5 `WarTypeDCivil War: Local Issues` -1889.24 1804.41  0.30
## 6                     WarTypeDOther -1307.02 2705.21  0.63
\end{verbatim}

\begin{verbatim}
##                             Description    R2                         Variables
## 1 Relative difference in deaths imputed 0.011                       (Intercept)
## 2                                                     `AmericasNot in Americas`
## 3                                                                  StartYR_Norm
## 4                                                                    WDuratDays
## 5                                             `WarTypeDCivil War: Local Issues`
## 6                                                                 WarTypeDOther
##   Estimate Std err p-val
## 1   0.0037  0.0024 0.125
## 2    0.003  0.0025 0.234
## 3  1.1e-05 1.7e-05 0.534
## 4  1.7e-06 7.5e-07 0.022
## 5  0.00024  0.0022 0.911
## 6  -0.0017  0.0032 0.601
\end{verbatim}
...
\includegraphics[width=14.44in]{/home/rstudio/Overall_plots/Python_proj_violin}
