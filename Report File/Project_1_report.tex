...
\begin{verbatim}
##                             Description     R2
## 1 Absolute difference in deaths imputed 0.0015
## 2                                             
## 3                                             
## 4                                             
## 5                                             
## 6                                             
##                           Variables Estimate Std err p-val
## 1                       (Intercept)   280.43 2055.91 0.892
## 2         `AmericasNot in Americas`  1459.12 2129.37 0.494
## 3                      StartYR_Norm     7.63   14.88 0.609
## 4                        WDuratDays    -1.23    0.64 0.058
## 5 `WarTypeDCivil War: Local Issues` -2388.06 1857.88 0.200
## 6                     WarTypeDOther -3546.48 2785.36 0.204
\end{verbatim}

\begin{verbatim}
##                             Description    R2                         Variables
## 1 Relative difference in deaths imputed 0.017                       (Intercept)
## 2                                                     `AmericasNot in Americas`
## 3                                                                  StartYR_Norm
## 4                                                                    WDuratDays
## 5                                             `WarTypeDCivil War: Local Issues`
## 6                                                                 WarTypeDOther
##   Estimate Std err  p-val
## 1   0.0084  0.0024 <0.001
## 2  0.00044  0.0025   0.86
## 3 -7.6e-06 1.8e-05   0.67
## 4  2.9e-06 7.7e-07 <0.001
## 5  -0.0025  0.0022   0.25
## 6  -0.0047  0.0033   0.15
\end{verbatim}
...
\hypertarget{python-project-plot}{%
\section{Python project plot}\label{python-project-plot}}

A violin plot of absolute difference in initiator deaths by calendar
month was shown. The interest was in seeing if a general shape or
variability by calendar month might be different for a given war start
month. Not much was seen, however, though one war did standout in
December, which was annotated (Russian Civil War 1917-1920). In this
given war, the anti-Bolsheviks opposing Lenin's regime were perceived as
the war `initiators' despite fighting for independence and suffered the
relatively highest number of initiator casualties relatively to the
other side, of all the curated wars.

\includegraphics[width=8.89in]{/home/rstudio/Overall_plots/Python_proj_violin}
