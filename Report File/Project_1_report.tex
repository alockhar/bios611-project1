...
## 6                                                              WarTypeDOther
##   Estimate Std err p-val
## 1  -2430.5 1878.06  0.20
## 2  1881.85 1945.16  0.33
## 3    15.87   13.59  0.24
## 4    -0.52    0.59  0.38
## 5 -1685.96 1697.15  0.32
## 6 -3231.45  2544.4  0.21
\end{verbatim}

\begin{verbatim}
##                             Description    R2                         Variables
## 1 Relative difference in deaths imputed 0.012                       (Intercept)
## 2                                                     `AmericasNot in Americas`
## 3                                                                  StartYR_Norm
## 4                                                                    WDuratDays
## 5                                             `WarTypeDCivil War: Local Issues`
## 6                                                                 WarTypeDOther
##   Estimate Std err  p-val
## 1   0.0051  0.0023 0.0259
## 2   0.0046  0.0024 0.0556
## 3 -1.1e-05 1.7e-05 0.4884
## 4  2.1e-06 7.2e-07 0.0046
## 5  -0.0023  0.0021 0.2725
## 6  -0.0041  0.0031 0.1854
\end{verbatim}
