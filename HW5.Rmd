...
</br> I think normalization is needed when all numeric columns are present as with 1 column the total variance is over-explained by one component. Scaling the date in the pCA then distributed the data more to having 2-3 PCS rather than 1 for all 6 numeric columns.
</br>
